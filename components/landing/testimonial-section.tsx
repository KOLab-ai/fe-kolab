      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <StaggeredChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          <AnimatedCard className="glassmorphism border-white/10 dark:border-gray-800/50 hover:shadow-primary/10 relative overflow-hidden">
            ...
            <CardContent>
              <p className="italic">
                "KOLab.ai helped us find the perfect influencers for our product
                launch. The AI recommendations were spot-on, and we saw a 40%
                increase in engagement compared to our previous campaigns."
              </p>
            </CardContent>
          </AnimatedCard>
          <AnimatedCard className="glassmorphism border-white/10 dark:border-gray-800/50 hover:shadow-primary/10 relative overflow-hidden">
            ...
            <CardContent>
              <p className="italic">
                "The platform is incredibly intuitive and the recommendations
                are tailored perfectly to our brand values. We've found
                influencers who truly understand our products."
              </p>
            </CardContent>
          </AnimatedCard>
          <AnimatedCard className="glassmorphism border-white/10 dark:border-gray-800/50 hover:shadow-primary/10 relative overflow-hidden">
            ...
            <CardContent>
              <p className="italic">
                "KOLab.ai has transformed how we approach influencer marketing.
                The AI recommendations have saved us countless hours of research
                and improved our campaign ROI significantly."
              </p>
            </CardContent>
          </AnimatedCard>
        </StaggeredChildren>
