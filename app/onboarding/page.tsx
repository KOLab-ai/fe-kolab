...
const steps = ["Role Selection", "Profile Details", "Campaign Goals", "Target Audience", "Product Category", "Complete"]
...
export default function OnboardingPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0:
        return (
          <RoleSelection formData={formData} updateFormData={updateFormData} setIsNextDisabled={setIsNextDisabled} />
        )
      case 1:
        return (
          <ProfileDetails formData={formData} updateFormData={updateFormData} setIsNextDisabled={setIsNextDisabled} />
        )
      case 2:
        return (
          <CampaignGoals formData={formData} updateFormData={updateFormData} setIsNextDisabled={setIsNextDisabled} />
        )
      case 3:
        return (
          <TargetAudience formData={formData} updateFormData={updateFormData} setIsNextDisabled={setIsNextDisabled} />
        )
      case 4:
        return (
          <ProductCategory formData={formData} updateFormData={updateFormData} setIsNextDisabled={setIsNextDisabled} />
        )
      case 5:
